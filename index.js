...
const settings = {
  prefix: ';',
  token: 'Njg2MjUwMTU2OTcwMzQ0NDgw.XmUemA.K-g28qvkmTb9h2dGvwlXcCDE_f4'
}
client.on("ready", () => {
...
You now own :money_with_wings: ${output.balance}`)
  ...
  if (command === 'help') {
    message.author.send(";balance - sprawdzasz ilość mamony\n;work - pracaaa\n;daily - dzienna nagroda\n;coinflip heads/tails mamona - rzut monetą na monety 😂\n;Pay @gracz ilosc - przelewy u zgredka\n;dice 1-6 mamona - kostka się toczy win or die(brak mamony)\n;slots mamona - trzy takie same wygrywasz")
  }
});
